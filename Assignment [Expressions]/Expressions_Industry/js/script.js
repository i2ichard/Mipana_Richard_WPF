...
//Industry - I want to create a caluclator that uses the given information by the user of age to track the average age demographic of the people that visit a particular site throughout the span of an hour.
